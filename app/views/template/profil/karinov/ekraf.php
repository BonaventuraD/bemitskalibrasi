      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-xxl-6">
          <div class="text-center my-2">
            <h1 class="warnapaletputih fw-bolder mb-2 ">Kementerian Ekonomi Kreatif</h1>
          </div>
        </div>
      </div>

      <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid my-5" src="<?= base_url(); ?>assets/img/akarinov/ekraf/ekraf.png" style="border-radius: 20px 20px 20px 20px;" alt="Foto Kegiatan Kementerian Ristek BEM ITS" /></div>
      <div class="col-lg-8 col-xl-7 col-xxl-6 pt-5">
        <p class="lead fw-normal warnapaletputih mb-4">Kementerian Ekonomi Kreatif berperan untuk membantu mewujudkan BEM ITS mandiri finansial dan memfasilitasi ekosistem kewirausahaan di ITS sekaligus pusat informasi kewirausahaan bagi seluruh KM ITS.</p>
        <div class="my-5 text-start text-xl-start">
           <div class="container-fluid pt-3 my-5 warnabgnav rounded-3">
                <div class="accordion-item rounded-3">
                  ...
                  <div id="panelsStayOpen-dirjen" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-dirjen">
                    ...
                    <ol>
                      <li>Kedirjenan Integrasi dan Ekonomi Institut</li>
                      <li>Kedirjenan Riset dan Karya Ekonomi</li>
                    </ol>
                    </div>
                  </div>
                </div>
          ...
          <a class="btn btn-primary btn-lg px-4 me-sm-3" style="background-color: #FFD400;" href="https://line.me/ti/p/~jeffrykurniawan29" target="_blank">Hubungi Kami</a>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <div class="row">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 5.png">
                        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 31.png">
                        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                      <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 35.png">
                        <div class="card-body">
                          <h4 class="card-title text-center">Cut Sahda Nabila</h4>
                          <p class="card-text text-center">Sekertaris Menteri Ekraf</p>
                          <div class="text-center">
                            <!-- Linkedin -->
                            <a class="btn btn-link btn-floating btn-lg" target="_blank" href="https://www.linkedin.com/in/cutsahdan/" role="button" data-mdb-ripple-color="dark"><i style="color: #fffff;" class="fab fa-linkedin"></i></a>
                            <!-- Instagram -->
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 9.png">
                        <div class="card-body">
                ...
                <div class="carousel-item">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 11.png">
                        <div class="card-body">
                          <h4 class="card-title text-center">Rheza Marchellino</h4>
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 37.png">
                        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 18.png">
                        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 16.png">
                        <div class="card-body">
                ...
                <div class="carousel-item">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 39.png">
                        <div class="card-body">
                          <h4 class="card-title text-center">Charmanita Mentari</h4>
                          <p class="card-text text-center">Staff Ekraf</p>
                          <div class="text-center">
                            <!-- Instagram -->
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 24.png">
                        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 26.png">
                        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 1.png">
                        <div class="card-body">
                ...
                <div class="carousel-item">
                  ...
                  <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 22.png">
                        <div class="card-body">
                          <h4 class="card-title text-center">Mochamad Rifky</h4>
                          <p class="card-text text-center">Staff Ekraf</p>
                          <div class="text-center">
                            <!-- Linkedin -->
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 41.png">
                        <div class="card-body">
                          <h4 class="card-title text-center">Awang Ganda</h4>
                          <p class="card-text text-center">Staff Ekraf</p>
                          <div class="text-center">
                            <!-- Linkedin -->
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 33.png">
                        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 7.png">
                        <div class="card-body">
                ...
                <div class="carousel-item">
                  ...
                  <div class="col-md-3 mb-3 rounded-3">
                      <div class="card">
                        <img class="img-fluid rounded-3 " alt="100%x280" src="<?= base_url(); ?>assets/img/akarinov/ekraf/MenuArtboard 20.png">
                        <div class="card-body">
...
<div class="container-fluid py-5 slideprogress">
  ...
  <div class="container">
    ...
    <div class="progress">
      <div class="progress-bar" role="progressbar" style="background-color:#393999;width: 34.39%;" aria-valuenow="35.72" aria-valuemin="0" aria-valuemax="100">34.39%</div>
    </div>
    <br>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-3 mb-3 rounded-3">
        <div class="card bg-transparent border-0 shadow-none">
          ...
          <div class="card-body">
            <h5 class="card-title text-center fw-bold">Ekraf commerce</h5>
          </div>
        </div>
      </div>
