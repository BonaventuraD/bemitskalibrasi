<section style="background: url(&quot;<?= base_url(); ?>assets/img/inpus/dagri/kalibrasi/bg-inpus.svg&quot;) center / cover no-repeat, #12DBB9;">
        ...
        <h1 class="text-center" style="text-shadow: 2px 2px var(--bs-border-color-translucent);font-weight: bold;font-family: Gilroy;color: var(--bs-white);">Kementerian Dalam Negeri</h1>
        <div class="blank-space"></div>
        <div>
            <div class="container">
                <div class="row">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-collapse collapse show item-1" role="tabpanel" data-bs-parent="#accordion-2">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Kedirjenan Harmonisasi Internal<br></li>
