  ...
  <div class="container py-5">
    <div class="row justify-content-center py-5">
      <div class="row col py-5 text-center">
        ...
        <img class="img-fluid py-5" src="<?= base_url(); ?>assets/img/kominrel/kominrelicon.png" alt="">  
        </div>
        <div class="col-4 align-items-center d-flex">
        </div>
        <div class="col-4 align-items-center d-flex">
  ...
  <div class="container pb-5">
    <div class="row justify-content-center align-items-center">
      <div class="col mx-auto pb-5">
        <h2 class="warnapaletungu fw-bolder d-none d-sm-block text-center">Kementerian Yang Dinaungi</h2>
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-3 mb-3 rounded-3">
      ...
      <div class="col-md-3 mb-3  rounded-3">
        <div class="card bg-transparent border-0">
          <a class="text-center" href="<?= base_url(); ?>profil/hublu">Kementerian Hublu
            <img class="shadow-none img-fluid rounded-3 py-3" alt="100%x280" src="<?= base_url(); ?>assets/img/kominrel/hublu/kalibrasi/hubluter.png">
          </a>
