            ...
            <div class="card border-light card-border-radius" style="border-radius: 12px 12px 12px 12px;">
                ...
                <div class="card-body mx-3">
                    <form action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSed0lTP60VqFwY0WrZ4MxAqWE5jzcV5Lsrjg_6l7etL-lb3_A/formResponse">
                        <div class="mb-4">
                            <label for="exampleInputEmail1" class="form-label"><h4 class="fw-bold">Nama</h4></label>
                            <input type="text" name="entry.1165107732" placeholder="Masukkan Namamu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-4">
